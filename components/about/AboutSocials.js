  ...
  return (
    <ul role="list">
        <li className="flex flex-col h-6">
            <Link href={"https://github.com/Chaffexd"} target="_blank" className="flex items-center mb-4 text-sm font-medium transition hover:text-teal-500 dark:text-zinc-200 dark:hover:text-teal-500">
                <GitHubIcon />
            ...
            <Link href={"https://www.linkedin.com/in/shane-chaffe/"} target="_blank" className="flex items-center text-sm font-medium text-zinc-600 transition hover:text-teal-500 dark:text-zinc-200 dark:hover:text-teal-500">
                <LinkedInIcon />
